      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="dist/img/user1-128x128.jpg" alt="User Avatar" class="ml-3 img-size-50 img-circle">
              <div class="media-body">
                ...
                <p class="text-sm text-muted"><i class="mr-1 fa fa-clock-o"></i> 4 ساعت قبل</p>
              </div>
            </div>
            <!-- Message End -->
          </a>
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="dist/img/user8-128x128.jpg" alt="User Avatar" class="ml-3 img-size-50 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  پیمان احمدی
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="dist/img/user3-128x128.jpg" alt="User Avatar" class="ml-3 img-size-50 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  سارا وکیلی
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card">
              <div class="p-0 card-header d-flex">
                ...
                <ul class="p-2 mr-auto nav nav-pills">
                  <li class="nav-item">
                      ...
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            حسام موسوی
                            <small class="float-left contacts-list-date">1397/10/01</small>
                          </span>
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            سارا فرهانی
                            <small class="float-left contacts-list-date">2/23/2015</small>
                          </span>
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            نکیسا کیانی
                            <small class="float-left contacts-list-date">2/20/2015</small>
                          </span>
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            رحمت موسوی
                            <small class="float-left contacts-list-date">2/10/2015</small>
                          </span>
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            جکسون عبداللهی
                            <small class="float-left contacts-list-date">1/27/2015</small>
                          </span>
                    ...
                    <li>
                      <a href="#">
                        ...
                        <div class="contacts-list-info">
                          <span class="contacts-list-name">
                            کتایون ریحانی
                            <small class="float-left contacts-list-date">1/4/2015</small>
                          </span>
            ...
            <div class="card">
              ...
              <div class="clearfix card-footer">
                <button type="button" class="float-right btn btn-info"><i class="fa fa-plus"></i> جدید</button>
              </div>
            </div>
            <!-- /.card -->
          </section>
